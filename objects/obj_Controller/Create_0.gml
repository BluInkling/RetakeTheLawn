...
enemystats = {
	...
	tacoimp :
	{
		...
		hp : 4,
		armor : 0,
		idlespr : spr_tacoImpIdleMirror,
		movespr : spr_tacoImpRunMirror,
		attackspr : spr_tacoImpAttack,
		attacksprHB : spr_tacoImpAttack,//HB,
		spawnspr : spr_impSpawn,
		idlesprH : spr_tacoImpIdleMirror,
		movesprH : spr_tacoImpRunMirror,
		attacksprH : spr_tacoImpAttack,
		dyingspr: spr_impDying,
		deadspr: spr_impDead,
		headspr: spr_impHead,
		spd : 1.5,
