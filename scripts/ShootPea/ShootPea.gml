...
function ShootPea(){
	...
	firingdelay = main.firingspeed;
	var _x2 = x + lengthdir_x(7, image_angle - 0);
	var _y2 = y + lengthdir_y(7, image_angle - 0);
	with (instance_create_layer(_x2, _y2,"Bullets",obj_Projectile)) //whats in here happesn to THE CREATED BULLET
	{
