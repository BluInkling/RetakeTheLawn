...
ds_list_add(waves,[0,obj_Enemy,0,400,soldier]);
...
ds_list_add(waves,[1,obj_Enemy,0,300,soldier]);



ds_list_add(waves,[2,obj_Enemy,0,0,flag]);
ds_list_add(waves,[2,obj_Enemy,0,10,flag]);
ds_list_add(waves,[2,obj_Enemy,100,0,imp]);
ds_list_add(waves,[2,obj_Enemy,100,0,imp]);
ds_list_add(waves,[2,obj_Enemy,100,0,imp]);
ds_list_add(waves,[2,obj_Enemy,150,0,imp]);
ds_list_add(waves,[2,obj_Enemy,300,0,soldier]);
