	...
	if enemyType.behavior == "melee"{
		...
		if (_num > 0)
		{
		    for (var i = 0; i < _num; ++i;)
		    {
				...
				with(_list[| i]){
					//hp ++;
					if armor == 0 && enemyType != obj_Controller.enemystats.imp && enemyType != obj_Controller.enemystats.tacoimp && enemyType != obj_Controller.enemystats.flagzombie && !dying && !isDead{
